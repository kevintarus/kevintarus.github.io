...
tags: [python, windows, command prompt, script, SSID]
---

## Explanation

This script will be able to output the WiFi names and passwords that the device has ever been connected to.

## Requirements

In order for the script to run, the following are required:

- Windows operating system
- Python installed
- An IDE environment for python or Command prompt
